...
""",
                    ...
                    for r in rows:
                        ...
                        if not text:
                            continue
                        # Check if bot is mentioned anywhere in message when require_mention is set
                        if self.require_mention and self.bot_prefix:
                            if self.bot_prefix.lower() not in text.lower():
                                continue
